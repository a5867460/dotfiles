...
plugins=(git autojump cp web-search catimg extract tmux npm ubuntu command-not-found common-aliases tmuxinator laravel5 docker docker-compose yarn node ng golang)
...
export NVM_DIR="/home/yz/.nvm"
[ -s "$NVM_DIR/nvm.sh" ] && \. "$NVM_DIR/nvm.sh"  # This loads nvm


export GOROOT=/usr/local/go
export GOPATH=~/godir
export PATH=$PATH:/usr/local/go/bin:~/godir/bin/
