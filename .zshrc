...
plugins=(git autojump cp web-search catimg extract tmux npm ubuntu command-not-found common-aliases tmuxinator laravel5 docker docker-compose yarn node golang)
